...
fit.low.rank.plus.sparse <- function(Sigma, Lambda1, Lambda2, n, init=NULL,
                                     ...
                                     print_progress=T, print_every=1,
...
# correlation_filename = args[1]
# lambda1 = as.numeric(args[2])
# lambda2 = as.numeric(args[3])
# nsamples = as.numeric(args[3])
# corr = npyLoad(correlation_filename)
#
# p = fit.low.rank.plus.sparse(
#   corr,
#   lambda1,
#   lambda2,
#   nsamples
# )
# npySave('tmp_out_S.npy', p$S)
