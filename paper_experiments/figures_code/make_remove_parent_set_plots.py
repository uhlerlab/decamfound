...
with open('../results/synthetic/eval_removal_parent_set_results_all_keys.pkl', 'rb') as handle:
...
plt.tight_layout()
plt.savefig('../figures/remove_parent_set_linear_prop_metric.png')
plt.close()
...
ax.set_ylabel('Prop. Times MLL Wrong > MLL True', fontsize=12)
plt.tight_layout()
plt.savefig('../figures/remove_parent_set_non_linear_prop_metric.png')
plt.close()
...
plt.tight_layout()
plt.savefig('../figures/remove_parent_set_linear_mll_diff.png')
plt.close()
...
ax.set_ylabel('Log Odds (Wrong vs. True)', fontsize=12)
plt.tight_layout()
plt.savefig('../figures/remove_parent_set_non_linear_mll_diff.png')
plt.close()
